...
class WidgetOptionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('widget_options')->insert([
            ...
            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart icon', 'option_name' => 'Chart Icon', 'option_value' => 'ruler', 'created_at' => $now, 'updated_at' => $now],
            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart border', 'option_name' => 'Chart Border', 'option_value' => 'Horizontal borders', 'created_at' => $now, 'updated_at' => $now],

            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart top', 'option_name' => 'Chart Top', 'option_value' => '21', 'created_at' => $now, 'updated_at' => $now],
            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart bottom', 'option_name' => 'Chart Bottom', 'option_value' => '30', 'created_at' => $now, 'updated_at' => $now],
            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart text', 'option_name' => 'Chart Text', 'option_value' => 'Size Chart', 'created_at' => $now, 'updated_at' => $now],

            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart background color', 'option_name' => 'Chart Background Color', 'option_value' => '#FBF7E7', 'created_at' => $now, 'updated_at' => $now],
            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart text color', 'option_name' => 'Chart Text Color', 'option_value' => '#FBF7E7', 'created_at' => $now, 'updated_at' => $now],
            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart border color', 'option_name' => 'Chart Border Color', 'option_value' => '#FBF7E6', 'created_at' => $now, 'updated_at' => $now],
            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart row background color', 'option_name' => 'Chart Row Background Color', 'option_value' => '#FBF7E6', 'created_at' => $now, 'updated_at' => $now],

            ['shop_name' => 'apexstorecounter.myshopify.com', 'widget_type' => 'chart border thickness', 'option_name' => 'Chart Border Thickness', 'option_value' => 'Regular', 'created_at' => $now, 'updated_at' => $now],
